		...
		<section id="sec1">
			...
			<div class="border">
				<div class="pet">
					...
					<div class="pet-info">
						<p>
							펫 이름 : &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="" id=""/> <!-- jstl 사용해서 기존 값 가져옴 -->
						</p>
						<p>
							펫 종류 : &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="" id=""/>
						</p>
						<p>
							펫 몸무게 : <input type="number" name="" id="" step="0.1">kg
						</p>
						<p>
							펫 생일 : &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="" id="datepicker" />
						</p>
