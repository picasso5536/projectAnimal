...
<div class="footer-container">
	...
	<div class="footer-column">
		...
		<ul class="social-media-icons">
			<li><a href="https://www.instagram.com/mosi_n17/ ">인스타<i
					class="fab fa-facebook-f"></i></a></li>
			<li><a
				href="https://www.facebook.com/profile.php?id=100089533267077">페이스북<i
					class="fab fa-twitter"></i></a></li>
			<li><a
				href="https://www.youtube.com/channel/UClMcwyqQFHjkackxovU59ng">유튜브<i
