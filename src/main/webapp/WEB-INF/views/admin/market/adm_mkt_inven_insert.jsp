...
<body>
	<main>
		...
		<span id="page_info">관리자</span> <span id="sep1">|</span> <span
				...
				id="page_sKate">재고 등록</span>
			<div class="search_list">
			<form>
					<table id="list_table">
						<caption>재고 등록</caption>
						<tbody>
							<tr>
								<th class="title">공급사명</th>
								<td colspan="2">
									   <input type="text" name="c_name" size="20">
								</td>
							...
							<tr>
								...
								<td colspan="4">
									 <input type="text" name="m_name" size="10">&nbsp;-&nbsp;
									 <input type="text" name="m_name" size="10">&nbsp;-&nbsp;
									 <input type="text" name="m_name" size="10">
								</td>
							</tr>
							<tr>
								...
								<tr>
								<td colspan="5">
									<input type="button" onclick="inven_info()" value="등록하기">
