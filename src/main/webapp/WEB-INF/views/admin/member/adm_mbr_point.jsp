...
<script type="text/javascript">
	function p_pay(nickname) {
		...
		if (result) {
			...
			// Wait for popup to load and set focus
		...
		$(document).ready(function() {
			$('#search_btn').click(function() {
				...
				success : function(data) {
					console.log(data);
					$(".point_table").empty();
					var table = "<thead><tr><th></th><th>이름</th><th>닉네임</th><th>아이디</th><th>현재 포인트</th><th></th><th></th></tr>";
					$(data).each(function(k,v) {
						...
						table += "<td><button type=\"button\" class=\"more_btn\" onclick=\"location.href='adm_point_info.do?mbr_nickname="+ nickname+ "'\">상세</button></td>";
						table += "</tr>";
					})
					table += "</tbody>"
