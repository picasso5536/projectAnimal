					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" name="m_id" size="27" placeholder="test1" readonly></td>
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" name="writer" size="15" placeholder="fkfkfkdksh" readonly>
									&nbsp;@&nbsp;
									<input type="text" name="writer" size="15" placeholder="naver.com" readonly>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td class="addr_text" colspan="3">
									...
									<input type="text" id="sample6_postcode" size="17" placeholder="우편번호">
									<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
									<input type="text" id="sample6_address" size="43" placeholder="주소"><br>
									<input type="text" id="sample6_detailAddress" size="43" placeholder="상세주소">
