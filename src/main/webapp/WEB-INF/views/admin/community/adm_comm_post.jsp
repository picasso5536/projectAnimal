...
function adm_comm_post_management() {
    var result = confirm("등록 하시겠습니까?");
    if(result){
    location.href="adm_comm_post_management.do";
    }else {
    }
}
</script>
			...
			<div class="search_pdt">
					<form action="">
						<div class="option_ann">
							검색어&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="text" class="search_ann" id="search_slot" placeholder="공급사 명 입력">
						</div>
						<div class="option_ann">
							카테고리&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="text" class="search_ann" id="search_slot" placeholder="공급사 코드 입력">
						</div>
						<div class="option_ann">
							<div id="radio_ann">
								카테고리&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select
								class="selectbox" style="margin-left: 50px;">
								<option value="" disabled selected hidden> 카테고리 선택</option>
								<option value="announce_ann">심품</option>
								<option value="event_ann">의류</option>
							</select>
							</div>
						</div>
				...
				<caption>공급사 리스트</caption>
						...
						<tbody>
							<tr>
								...
								<td>1</td>
								<td>50000A</td>
								<td  onclick="location.href='adm_comm_post_registration.do'">공급사 이름 1</td>
								<td>도매</td>
								<td>거래중</td>
								<td>식품</td>
								<td>사용</td>
							...
							<tr>
								...
								<td>1</td>
								<td>50000A</td>
								<td class="cursor: pointer;" onclick="location.href='adm_comm_post_registration.do'">공급사 이름 1</td>
								<td>도매</td>
								<td>거래중</td>
								<td>식품</td>
								<td>사용</td>
					...
					<button type="button" class="select_ann1" onclick="adm_comm_post_management()" >등록</button>
			</div>
		</section>
	</main>
</body>
