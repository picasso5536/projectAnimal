...
<script type="text/javascript">
	...
	$(document).on(
			...
			function() {
				...
				$(".modal_answer_btn").attr("data-repNum", repNum);
			});
</script>
</head>
<body>
	<main>
		...
		<section id="sec1">
			<span id="page_info">관리자</span> <span id="sep1">|</span> <span
				...
				id="page_sKate">문의 관리</span>
			<div class="border">
				<div class="inquire">
					<form action="">
						<div class="option_inq">
							검색어&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select
								class="selectbox">
								<option value="author">작성자</option>
								<option value="title">제목</option>
								<option value="content">제목 + 내용</option>
							</select><input type="text" class="search_inq" id="search_slot"
								placeholder="검색어 입력">
						</div>
						<div class="option_inq">
							카테고리&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select
						...
						<div class="option_inq">
							<div id="radio_inq">
								영역&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
									<input type="radio" name="area_inq" value="area_all" checked>
									전체
								</label> &nbsp;&nbsp;<label> <input type="radio" name="area_inq"
									value="main"> 메인
								</label> &nbsp;&nbsp;<label> <input type="radio" name="area_inq"
									value="market"> 마켓
								</label> &nbsp;&nbsp;<label> <input type="radio" name="area_inq"
						...
						<div class="option_inq">
							<div id="radio_inq">
								상태&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>
									<input type="radio" name="state_inq" value="state_all" checked>
									전체
								</label> &nbsp;&nbsp;<label> <input type="radio"
									name="state_inq" value="main"> 답변 대기중
								</label> &nbsp;&nbsp;<label> <input type="radio"
									name="state_inq" value="market"> 답변 완료
								</label>
							</div>
						</div>
						<div class="start_end">
						...
						<div id="search_inq_btn">
							<button type="button" id="select_inq">조회</button>
							<button type="button" id="init_inq">검색 초기화</button>
						</div>
					</form>
					<table class="cols">
						<thead>
	...
	<div class="replyModal">
		<div class="modalContent">
			...
			<div>
				<button type="button" class="modal_answer_btn">답변</button>
	...
	<script>
		...
		$(".modal_answer_btn").click(function() {
